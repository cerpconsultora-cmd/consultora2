...
export default function GestionPreventivaPage() {
  ...
  return (
    <main className="pt-24 pb-0 bg-gray-50">
      ...
      <FAQ 
        title="Preguntas Frecuentes sobre Gestión Preventiva"
        items={[
          { question: "¿Qué debe incluir un Plan de Emergencia y Evacuación?", answer: "Un plan estructurado debe contener los roles de actuación (quién hace qué), las vías de escape seguras, los puntos de encuentro, la ubicación de extintores y los protocolos específicos para diferentes tipos de incidentes (incendio, amenazas, etc)." },
          { question: "¿Es obligatorio tener mapas de riesgo?", answer: "Sí. Los planos de evacuación y mapas de riesgo deben estar visibles en áreas estratégicas de la institución, según lo requiere la normativa vigente y los entes de habilitación municipal." },
          { question: "¿Ustedes se encargan de la presentación ante los organismos?", answer: "Sí, armamos los Legajos Técnicos y asesoramos en todo el proceso de presentación de protocolos y planes ante los organismos de control provinciales y municipales." }
        ]} 
      />
