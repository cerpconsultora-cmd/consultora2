        ...
        <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg text-gris leading-relaxed mb-8">
              Acompañamos a tu industria en el cumplimiento normativo y la reducción de la siniestralidad. Protegé tu capital humano y optimizá tus operaciones.
            </p>
          ...
          >
            <div className="bg-gray-50 rounded-3xl p-16 flex items-center justify-center border border-gray-100">
               <Factory className="w-32 h-32 text-azul opacity-20" />
            </div>
          </motion.div>
        </div>
      </section>
