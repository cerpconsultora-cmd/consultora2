...
export default function SeguridadHigienePage() {
  ...
  return (
    <main className="pt-24 pb-0 bg-blanco">
      ...
      <FAQ 
        title="Preguntas Frecuentes sobre Seguridad e Higiene"
        items={[
          { question: "¿Qué exige la SRT en materia de Seguridad e Higiene?", answer: "La Superintendencia de Riesgos del Trabajo (SRT) exige cumplir con la Ley 19.587, que implica contar con un Servicio de Seguridad e Higiene, realizar capacitaciones periódicas, entregar EPP y mantener actualizada la documentación (Legajo Técnico)." },
          { question: "¿Cada cuánto se debe realizar una auditoría SST?", answer: "Recomendamos auditorías integrales al menos una vez al año, y controles periódicos mensuales o bimestrales dependiendo del nivel de riesgo de la actividad (construcción, industria, etc)." },
          { question: "¿Qué empresas están obligadas a tener un servicio de Seguridad e Higiene?", answer: "Toda empresa u organización que cuente con personal en relación de dependencia debe cumplir con las normativas de seguridad e higiene, aunque la cantidad de horas profesionales exigidas varía según la cantidad de empleados y el riesgo de la actividad." }
        ]} 
      />
